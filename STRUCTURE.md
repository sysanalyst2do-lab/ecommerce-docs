...
Каталог учебных материалов и артефактов для онбординга.

#### Вложенные папки onboarding

```text
onboarding/
├── lessons/                 # Практические материалы и учебные примеры
├── notation/                # Нотации и диаграммы
│   ├── BPMN/                # Бизнес-процессы в BPMN
│   ├── C4/                  # Архитектурные диаграммы C4
│   └── UML/                 # UML-диаграммы (классы, активности, последовательности)
```

### ONBOARDING_LIST.md

Единый список материалов и артефактов для онбординга.
Файл размещён в корне репозитория для быстрого поиска и скачивания.

- Просмотр: `ONBOARDING_LIST.md`
- Скачать (raw): `https://raw.githubusercontent.com/sysanalyst2do-lab/ecommerce-docs/onboarding/ONBOARDING_LIST.md`
